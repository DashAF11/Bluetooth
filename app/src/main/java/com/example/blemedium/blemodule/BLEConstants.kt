...
class BLEConstants {
    ...
    companion object {
        const val ACTION_GATT_CONNECTED =
            "com.example.blemedium.ACTION_GATT_CONNECTED" //Strings representing actions to broadcast to activities
        const val ACTION_GATT_DISCONNECTED =
            "com.example.blemedium.ACTION_GATT_DISCONNECTED" // Old com.zco.ble
        const val ACTION_GATT_SERVICES_DISCOVERED =
            "com.example.blemedium.ACTION_GATT_SERVICES_DISCOVERED"
        const val ACTION_DATA_AVAILABLE = "com.example.blemedium.ACTION_DATA_AVAILABLE"
        const val ACTION_DATA_WRITTEN = "com.example.blemedium.ACTION_DATA_WRITTEN"
        const val EXTRA_DATA = "com.example.blemedium.EXTRA_DATA"
        const val EXTRA_UUID = "com.example.blemedium.EXTRA_UUID"
